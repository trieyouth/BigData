...
<%-- <tr> --%>
<%-- <td colspan="5" height="30px" style="text-align:center; font-size: 30px;"><label  id="labelhead">采集记录 </label></td> --%>
<%-- </tr> --%>
<%-- <tr> --%>
...
<%--    <c:forEach items="${Templatedata}" var="cdt"> --%>
...
<%--       <!--生成数量--> --%>
<%--       <td width="20%"  height="30"class="cell"><label id="labelbody" >${ cdt.adminId }</label></td>  --%>
<%--        <!--操作人--> --%>
<%--       <td width="20%"  height="30"><label id="labelbody" ><a href= style="color:#09F">查看详情</a></label></td>		 --%>
<%--       <!--根据编号去跳转到此模板的相应也页面，yongjsp改href--> --%>
<%--       <td width="10%"  height="30"><label id="labelbody" ><a href=<%= %> style="color:#09F">删除</a></label></td>  --%>
<%--        <!--删除该模板--> --%>
<%--     </tr> --%>
<%--    </c:forEach>  --%>
<%--   </table> --%>
