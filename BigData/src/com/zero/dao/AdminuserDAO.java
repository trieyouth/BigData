...
public class AdminuserDAO  {
    ...
    public Adminuser findById( java.lang.Integer id) {
        ...
        try {
            Adminuser instance = (Adminuser) getCurrentSession()
                    .get("com.zero.entity.Adminuser", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<Adminuser> findByExample(Adminuser instance) {
        ...
        try {
            List<Adminuser> results = (List<Adminuser>) getCurrentSession() .createCriteria("com.zero.entity.Adminuser").add( create(instance) ).list();
