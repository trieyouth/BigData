...
<form  method="post" action="<c:url value="/icpas/index/dataCollect/generateData"/>">
  <div style="height:4px; width:100%;"></div>
  <div id="lightcolor">
    <div style="height:4px; width:60%;text-align:center;"><label  id="labelhead">数据录入</label></div>
    <div style="height:4px; width:100%;"></div>
    <table frame="void" width = "60%" height="25" >
      <tr>
        ...
        <td width="60%"  height="25"  ><label id="labelbody" >
            <input  type="text" id="inputwidth"   name="nianling1" ></label></td>
        </tr>
      <tr>
      ...
      <tr>
        ...
        <td width="60%"  height="25"  ><label id="labelbody" >
            <input  type="text" id="inputwidth"  placeholder=""  name="nianling1" ></label></td>
        </tr>
        <tr>
  ...
  <!--选择按钮功能-->
  <div id="buttoncon">
    <button name="btnGenerate" type="submit" id="button1style">生成模拟数据</button>
    <button name="btnGenerate" type="reset" id="button2style">重填</button>
  </div>
</form>
  </body>
</html>
